...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-reflux/node_modules/reflux/src/defineReact.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-reflux">npmtest-reflux (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-reflux/node_modules/reflux/src/defineReact.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25.29% <small>(43 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">13.86% <small>(14 / 101)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">21.74% <small>(5 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">25.29% <small>(43 / 170)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-reflux/node_modules/reflux/src/</a> &#187; defineReact.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* globals React: false */
&nbsp;
...
function defineReact(react, noLongerUsed, extend)
{
	...
	try {
		_react  = react  || _react  || <span class="branch-2 cbranch-no" title="branch not covered" >React;</span>
...
<span class="cstat-no" title="statement not covered" >		return;</span>
	...
	<span class="missing-if-branch" title="if path not taken" >I</span>if (!_react || !_extend || (_defined &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >!extend)</span>) {
<span class="cstat-no" title="statement not covered" >		return;</span>
	}
	 ...
	 */
	var RefluxComponent = <span class="fstat-no" title="function not covered" >function(props, context, updater) {</span>
<span class="cstat-no" title="statement not covered" >		_extend.call(this, props, context, updater);</span>
	};
	...
	proto.componentWillMount = <span class="fstat-no" title="function not covered" >function () {</span>
		// if there is a this.store then simply push it onto the this.stores array or make one if needed
<span class="cstat-no" title="statement not covered" >		if (this.store) {</span>
<span class="cstat-no" title="statement not covered" >			if (Array.isArray(this.stores)) {</span>
<span class="cstat-no" title="statement not covered" >				this.stores.unshift(this.store);</span>
			} else {
<span class="cstat-no" title="statement not covered" >				this.stores = [this.store];</span>
			}
		}
		
<span class="cstat-no" title="statement not covered" >		if (this.stores) {</span>
<span class="cstat-no" title="statement not covered" >			this.__storeunsubscribes__ = this.__storeunsubscribes__ || [];</span>
<span class="cstat-no" title="statement not covered" >			var sS = this.setState.bind(this);</span>
			// this handles the triggering of a store, checking what's updated if proto.storeKeys is utilized
<span class="cstat-no" title="statement not covered" >			var onStoreTrigger = <span class="fstat-no" title="function not covered" >function(obj){</span></span>
<span class="cstat-no" title="statement not covered" >				var updateObj = filterByStoreKeys(this.storeKeys, obj);</span>
<span class="cstat-no" title="statement not covered" >				if (updateObj) {</span>
<span class="cstat-no" title="statement not covered" >					sS(updateObj);</span>
				}
			}.bind(this);
			// for each store in this.stores...
<span class="cstat-no" title="statement not covered" >			for (var i = 0, ii = this.stores.length; i &lt; ii; i++) {</span>
<span class="cstat-no" title="statement not covered" >				var str = this.stores[i];</span>
				// if's a function then we know it's a class getting passed, not an instance
<span class="cstat-no" title="statement not covered" >				if (typeof str === 'function') {</span>
<span class="cstat-no" title="statement not covered" >					var storeId = str.id;</span>
					// if there is NOT a .singleton property on the store then this store has not been initialized yet, so do so
<span class="cstat-no" title="statement not covered" >					if (!str.singleton) {</span>
<span class="cstat-no" title="statement not covered" >						str.singleton = new str();</span>
<span class="cstat-no" title="statement not covered" >						if (storeId) {</span>
<span class="cstat-no" title="statement not covered" >							Reflux.stores[storeId] = str.singleton;</span>
						}
					}
...
<span class="cstat-no" title="statement not covered" >					this.stores[i] = str = str.singleton;</span>
					// the instance should have an .id property as well if the class does, so set that here
<span class="cstat-no" title="statement not covered" >					str.id = storeId;</span>
...
<span class="cstat-no" title="statement not covered" >					if (storeId &amp;&amp; Reflux.GlobalState[storeId]) {</span>
<span class="cstat-no" title="statement not covered" >						for (var key in Reflux.GlobalState[storeId]) {</span>
<span class="cstat-no" title="statement not covered" >							str.state[key] = Reflux.GlobalState[storeId][key];</span>
						}
<span class="cstat-no" title="statement not covered" >						Reflux.GlobalState[storeId] = str.state;</span>
					// otherwise (if it has an id) set the global state to the default state of the store
					} else <span class="cstat-no" title="statement not covered" >if (storeId) {</span>
<span class="cstat-no" title="statement not covered" >						Reflux.GlobalState[storeId] = str.state;</span>
					}
...
<span class="cstat-no" title="statement not covered" >				if (!Reflux.serverMode) {</span>
<span class="cstat-no" title="statement not covered" >					this.__storeunsubscribes__.push(str.listen(onStoreTrigger));</span>
				}
				// run set state so that it mixes in the props from the store with the component
<span class="cstat-no" title="statement not covered" >				var updateObj = filterByStoreKeys(this.storeKeys, str.state);</span>
<span class="cstat-no" title="statement not covered" >				if (updateObj) {</span>
<span class="cstat-no" title="statement not covered" >					this.setState(updateObj);</span>
				}
			}
		}
		
		// mapStoreToState needs to know if is ready to map or must wait
<span class="cstat-no" title="statement not covered" >		this.__readytomap__ = true;</span>
		// if there are mappings that were delayed, do them now
<span class="cstat-no" title="statement not covered" >		var dmaps = this.__delayedmaps__;</span>
<span class="cstat-no" title="statement not covered" >		if (dmaps) {</span>
<span class="cstat-no" title="statement not covered" >			for (var j=0,jj=dmaps.length; j&lt;jj; j++) {</span>
<span class="cstat-no" title="statement not covered" >				dmaps[j].func( dmaps[j].state );</span>
			}
		}
<span class="cstat-no" title="statement not covered" >		this.__delayedmaps__ = null;</span>
	};
	
	// on the unmount phase of the component unsubscribe that which we subscribed earlier to keep our garbage trail clean
	proto.componentWillUnmount = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >		if (this.__storeunsubscribes__) {</span>
<span class="cstat-no" title="statement not covered" >			for (var i = 0, ii = this.__storeunsubscribes__.length; i &lt; ii; i++) {</span>
<span class="cstat-no" title="statement not covered" >				this.__storeunsubscribes__[i]();</span>
			}
		}
<span class="cstat-no" title="statement not covered" >		this.__readytomap__ = false;</span>
	};
	 ...
	 */
	proto.mapStoreToState = <span class="fstat-no" title="function not covered" >function(store, filterFunc)</span>
	{
		// make sure we have a proper singleton instance to work with
<span class="cstat-no" title="statement not covered" >		if (typeof store === 'function') {</span>
<span class="cstat-no" title="statement not covered" >			if (store.singleton) {</span>
<span class="cstat-no" title="statement not covered" >				store = store.singleton;</span>
			} else {
<span class="cstat-no" title="statement not covered" >				store = Reflux.initStore(store);</span>
			}
		}
...
<span class="fstat-no" title="function not covered" >		function onMapStoreTrigger(obj) {</span>
			// get an object 
<span class="cstat-no" title="statement not covered" >			var update = filterFunc.call(self, obj);</span>
...
<span class="cstat-no" title="statement not covered" >				return;</span>
			...
			/*jshint unused: false */
<span class="cstat-no" title="statement not covered" >			var hasProps = false;</span>
<span class="cstat-no" title="statement not covered" >			for (var check in update) {</span>
<span class="cstat-no" title="statement not covered" >				hasProps = true;</span>
<span class="cstat-no" title="statement not covered" >				break;</span>
			}
			// if there were props mapped, then update via setState
<span class="cstat-no" title="statement not covered" >			if (hasProps) {</span>
<span class="cstat-no" title="statement not covered" >				self.setState(update);</span>
			}
		}
		
		// add the listener to know when the store is triggered
<span class="cstat-no" title="statement not covered" >		this.__storeunsubscribes__ = this.__storeunsubscribes__ || [];</span>
<span class="cstat-no" title="statement not covered" >		this.__storeunsubscribes__.push(store.listen(onMapStoreTrigger));</span>
...
<span class="cstat-no" title="statement not covered" >		if (this.__readytomap__) {</span>
<span class="cstat-no" title="statement not covered" >			onMapStoreTrigger(store.state);</span>
		} else {
<span class="cstat-no" title="statement not covered" >			this.__delayedmaps__ = this.__delayedmaps__ || [];</span>
<span class="cstat-no" title="statement not covered" >			this.__delayedmaps__.push({func:onMapStoreTrigger, state:store.state});</span>
		}
	};
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if (_react.PureComponent) {
	 ...
	 */
	var RefluxStore = <span class="fstat-no" title="function not covered" >function() {</span>
...
<span class="cstat-no" title="statement not covered" >		this.__store__ = Reflux.createStore();</span>
<span class="cstat-no" title="statement not covered" >		this.state = {};</span>
<span class="cstat-no" title="statement not covered" >		var self = this;</span>
<span class="cstat-no" title="statement not covered" >		for (var key in this.__store__) {</span>
			/*jshint loopfunc: true */
<span class="cstat-no" title="statement not covered" >			(<span class="fstat-no" title="function not covered" >function (prop) {</span></span>
<span class="cstat-no" title="statement not covered" >				Object.defineProperty(self, prop, {</span>
					get: <span class="fstat-no" title="function not covered" >function () {</span> <span class="cstat-no" title="statement not covered" >return self.__store__[prop]; </span>},
					set: <span class="fstat-no" title="function not covered" >function (v) {</span> <span class="cstat-no" title="statement not covered" >self.__store__[prop] = v; </span>}
				});
			})(key);
		}
	};
...
<span class="cstat-no" title="statement not covered" >			if (Array.isArray(v)){</span>
<span class="cstat-no" title="statement not covered" >				v.forEach(<span class="fstat-no" title="function not covered" >function(obj) {</span></span>
<span class="cstat-no" title="statement not covered" >					for (var key in obj) {</span>
<span class="cstat-no" title="statement not covered" >						Combined[key] = obj[key];</span>
					}
				});
			} else {
<span class="cstat-no" title="statement not covered" >				Combined = v;</span>
			}
<span class="cstat-no" title="statement not covered" >			this.__listenables__ = Combined;</span>
<span class="cstat-no" title="statement not covered" >			this.listenToMany(Combined);</span>
		},
		enumerable: true,
		configurable: true
	});
	...
	proto.setState = <span class="fstat-no" title="function not covered" >function (obj) {</span>
		// Object.assign(this.state, obj); // later turn this to Object.assign and remove loop once support is good enough
<span class="cstat-no" title="statement not covered" >		for (var key in obj) {</span>
<span class="cstat-no" title="statement not covered" >			this.state[key] = obj[key];</span>
		}
...
<span class="cstat-no" title="statement not covered" >			Reflux.GlobalState[this.id] = this.state;</span>
		}
...
<span class="cstat-no" title="statement not covered" >		this.trigger(obj);</span>
	};
	...
	Object.defineProperty(RefluxStore, "state", {
		get: function () {
			<span class="missing-if-branch" title="else path not taken" >E</span>if (!this.singleton) {
				throw new Error('Reflux.Store.state is inaccessible before the store has been initialized.');
			}
<span class="cstat-no" title="statement not covered" >			return this.singleton.state;</span>
		},
		enumerable: true,
		configurable: true
	});
	 ...
	 */
	Reflux.getGlobalState = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		return clone(Reflux.GlobalState);</span>
	};
	 ...
	 */
	Reflux.setGlobalState = <span class="fstat-no" title="function not covered" >function(obj) {</span>
<span class="cstat-no" title="statement not covered" >		for (var storeID in obj) {</span>
<span class="cstat-no" title="statement not covered" >			if (Reflux.stores[storeID]) {</span>
<span class="cstat-no" title="statement not covered" >				Reflux.stores[storeID].setState(obj[storeID]);</span>
			} else {
<span class="cstat-no" title="statement not covered" >				Reflux.GlobalState[storeID] = obj[storeID];</span>
			}
		}
	};
	...
	Reflux.initializeGlobalStore = Reflux.initStore = <span class="fstat-no" title="function not covered" >function(str) {</span>
<span class="cstat-no" title="statement not covered" >		var storeId = str.id;</span>
		// if they're initializing something twice then we're done already, return it
<span class="cstat-no" title="statement not covered" >		if (str.singleton) {</span>
<span class="cstat-no" title="statement not covered" >			return str.singleton;</span>
		}
...
<span class="cstat-no" title="statement not covered" >		var inst = str.singleton = new str();</span>
		// store it on the Reflux.stores array to be accessible later
<span class="cstat-no" title="statement not covered" >		Reflux.stores[storeId] = inst;</span>
		// the singleton instance itself should also have the id property of the class
<span class="cstat-no" title="statement not covered" >		inst.id = storeId;</span>
...
<span class="cstat-no" title="statement not covered" >		if (Reflux.GlobalState[storeId]) {</span>
<span class="cstat-no" title="statement not covered" >			for (var key in Reflux.GlobalState[storeId]) {</span>
<span class="cstat-no" title="statement not covered" >				inst.state[key] = Reflux.GlobalState[storeId][key];</span>
			}
<span class="cstat-no" title="statement not covered" >			Reflux.GlobalState[storeId] = inst.state;</span>
...
<span class="fstat-no" title="function not covered" >function filterByStoreKeys(storeKeys, obj)</span>
{
	// if there are not storeKeys defined then simply return the whole original object
<span class="cstat-no" title="statement not covered" >	if (!storeKeys) {</span>
...
<span class="cstat-no" title="statement not covered" >	var doUpdate = false;</span>
<span class="cstat-no" title="statement not covered" >	var updateObj = {};</span>
<span class="cstat-no" title="statement not covered" >	for (var i = 0, ii = storeKeys.length; i &lt; ii; i++) {</span>
<span class="cstat-no" title="statement not covered" >		var prop = storeKeys[i];</span>
<span class="cstat-no" title="statement not covered" >		if (obj.hasOwnProperty(prop)) {</span>
<span class="cstat-no" title="statement not covered" >			doUpdate = true;</span>
<span class="cstat-no" title="statement not covered" >			updateObj[prop] = obj[prop];</span>
		}
	}
<span class="cstat-no" title="statement not covered" >	return doUpdate ? updateObj : false;</span>
}
&nbsp;
...
<span class="fstat-no" title="function not covered" >function clone(frm, to) {</span>
<span class="cstat-no" title="statement not covered" >	if (frm === null || typeof frm !== "object") {</span>
<span class="cstat-no" title="statement not covered" >		return frm;</span>
	}
<span class="cstat-no" title="statement not covered" >	if (frm.constructor !== Object &amp;&amp; frm.constructor !== Array) {</span>
<span class="cstat-no" title="statement not covered" >		return frm;</span>
	}
<span class="cstat-no" title="statement not covered" >	if (frm.constructor === Date || frm.constructor === RegExp || frm.constructor === Function ||</span>
		frm.constructor === String || frm.constructor === Number || frm.constructor === Boolean) {
<span class="cstat-no" title="statement not covered" >		return new frm.constructor(frm);</span>
	}
<span class="cstat-no" title="statement not covered" >	to = to || new frm.constructor();</span>
<span class="cstat-no" title="statement not covered" >	for (var name in frm) {</span>
<span class="cstat-no" title="statement not covered" >		to[name] = typeof to[name] === "undefined" ? clone(frm[name], null) : to[name];</span>
	}
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 18 2017 17:18:47 GMT+0000 (UTC)</div>
</div>
</body>
</html>
