...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-reflux/node_modules/reflux-core/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-reflux/node_modules/reflux-core/lib/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">69.74% <small>(53 / 76)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-reflux/node_modules/reflux-core/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
var createActions = function () {
    var reducer = <span class="fstat-no" title="function not covered" >function reducer(definitions, actions) {</span>
<span class="cstat-no" title="statement not covered" >        Object.keys(definitions).forEach(<span class="fstat-no" title="function not covered" >function (actionName) {</span></span>
<span class="cstat-no" title="statement not covered" >            var val = definitions[actionName];</span>
<span class="cstat-no" title="statement not covered" >            actions[actionName] = (0, _createAction.createAction)(val);</span>
        });
    };
&nbsp;
    return <span class="fstat-no" title="function not covered" >function (definitions) {</span>
<span class="cstat-no" title="statement not covered" >        var actions = {};</span>
<span class="cstat-no" title="statement not covered" >        if (definitions instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >            definitions.forEach(<span class="fstat-no" title="function not covered" >function (val) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (_.isObject(val)) {</span>
<span class="cstat-no" title="statement not covered" >                    reducer(val, actions);</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    actions[val] = (0, _createAction.createAction)(val);</span>
                }
            });
        } else {
<span class="cstat-no" title="statement not covered" >            reducer(definitions, actions);</span>
        }
 ...
 */
<span class="fstat-no" title="function not covered" >function setEventEmitter(ctx) {</span>
<span class="cstat-no" title="statement not covered" >    _.EventEmitter = ctx;</span>
}
&nbsp;
/**
 * Sets the method used for deferring actions and stores
 */
<span class="fstat-no" title="function not covered" >function nextTick(nextTick) {</span>
<span class="cstat-no" title="statement not covered" >    _.nextTick = nextTick;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function use(pluginCb) {</span>
<span class="cstat-no" title="statement not covered" >    pluginCb(this);</span>
}
&nbsp;
/**
 ...
 */
<span class="missing-if-branch" title="if path not taken" >I</span>if (!Function.prototype.bind) {
<span class="cstat-no" title="statement not covered" >    console.error("Function.prototype.bind not available. " + "ES5 shim required. " + "https://github.com/spoike/refluxjs#es5");</span>
}
&nbsp;</pre></td></tr>
</table></pre>
</div>
